 ...
 */
public class SemanticsAntonymsSynonymsFragment_fm extends BaseFragment {

    TextView mTvQuestion;
    Button mBtnNext;

    public static SemanticsAntonymsSynonymsFragment_fm newInstance(Integer questionId, Integer screeningId){
        Bundle args = new Bundle();
        //args.putInt(ID_KEY, id);
        args.putInt(QUESTION_ID_KEY, questionId);
        args.putInt (SCREENING_ID_KEY , screeningId);

        SemanticsAntonymsSynonymsFragment_fm fragment = new SemanticsAntonymsSynonymsFragment_fm();
