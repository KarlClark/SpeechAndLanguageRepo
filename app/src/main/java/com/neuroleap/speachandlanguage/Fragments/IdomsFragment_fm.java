 ...
 */
public class IdomsFragment_fm extends  BaseFragment {

    TextView mTvQuestion;
    Button mBtnNext;

    public static IdomsFragment_fm newInstance(Integer questionId){
        Bundle args = new Bundle();
        //args.putInt(ID_KEY, id);
        args.putInt(QUESTION_ID_KEY, questionId);

        IdomsFragment_fm fragment = new IdomsFragment_fm();
