 ...
 */
public class ProcessingNegativeWhyFragment extends  QuestionsBaseFragment {

    private ImageView mIvPicture;

    public static ProcessingNegativeWhyFragment newInstance(Integer questionId, Integer screeningId, Long screeningCategoryId, Integer pageViewerPosition, Integer groupPosition){
