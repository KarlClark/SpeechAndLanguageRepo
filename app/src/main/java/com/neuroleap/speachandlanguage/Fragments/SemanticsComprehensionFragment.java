 ...
 */
public class SemanticsComprehensionFragment extends QuestionsBaseFragment {

    private ImageView mIvPicture;

    public static SemanticsComprehensionFragment newInstance(Integer questionId, Integer screeningId, Long screeningCategoryId, Integer pageViewerPosition, Integer groupPosition){
