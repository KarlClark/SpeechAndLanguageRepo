 ...
 */
public class InferencesFragment extends  QuestionsBaseFragment{

    TextView mTvQuestion;
    Button mBtnNext;

    public static InferencesFragment newInstance(Integer questionId , Integer screeningId, Integer position){
