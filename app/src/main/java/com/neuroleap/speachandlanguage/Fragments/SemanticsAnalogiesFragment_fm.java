 ...
 */
public class SemanticsAnalogiesFragment_fm extends BaseFragment {

    TextView mTvQuestion;
    Button mBtnNext;

    public static SemanticsAnalogiesFragment_fm newInstance(Integer questionId, Integer screeningId){
        Bundle args = new Bundle();
        //args.putInt(ID_KEY, id);
        args.putInt(QUESTION_ID_KEY, questionId);
        args.putInt (SCREENING_ID_KEY , screeningId);

        SemanticsAnalogiesFragment_fm fragment = new SemanticsAnalogiesFragment_fm();
