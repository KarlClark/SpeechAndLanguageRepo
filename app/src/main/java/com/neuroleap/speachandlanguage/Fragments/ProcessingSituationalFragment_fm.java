 ...
 */
public class ProcessingSituationalFragment_fm extends  BaseFragment{

    TextView mTvQuestion;
    Button mBtnNext;

    public static ProcessingSituationalFragment_fm newInstance(Integer questionId, Integer screeningId){
        Bundle args = new Bundle();
        //args.putInt(ID_KEY, id);
        args.putInt(QUESTION_ID_KEY, questionId);
        args.putInt (SCREENING_ID_KEY , screeningId);

        ProcessingSituationalFragment_fm fragment = new ProcessingSituationalFragment_fm();
